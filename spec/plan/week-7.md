...
> **Before marking the project ready for submission, run the production smoke tests** defined in [`test-plan.md`](./test-plan.md) against the live Vercel deployment.
> All critical and high-priority tests must be green.
