...
import { Building2, Gamepad2, Activity, Shield } from 'lucide-react'
...
interface AdminDashboardContentProps {
  stats: { totalOrgs: number; totalTryouts: number; activeTryouts: number }
  organizations: OrgRow[]
  tryouts: TryoutRow[]
}

type Tab = 'organizations' | 'tryouts'
